package com.laikaalper.sehirplakakodu

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.View
import com.laikaalper.sehirplakakodu.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize the binding using generated ActivityMainBinding class
            ...
            if (binding.editTextNumber.text.isNotEmpty()) {
                ...
                when (plakaKodu) {
                    ...
                    81 -> binding.textView.text = "Düzce"
                        ...
                        binding.textView.text = "Bulunamadı Tekrar Deneyiniz!"
                    }
                }
            } else {
